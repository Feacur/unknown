...
int main(int argc, char * argv[]) {
	...
	u64 const nanos_fixed_delta           = AsNanos(1.0 / 50.0);
	u64 const nanos_variable_delta_limit  = AsNanos(1.0 / 20.0);
	u64 const nanos_variable_delta_target = AsNanos(1.0 / 60.0);
